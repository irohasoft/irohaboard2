...
<?php
	switch($content->kind)
	{
		case 'url': // URLコンテンツ
			...
			break;
		case 'movie': // 動画コンテンツ
			$body = '<video src="'.h($content->url).'" controls width="100%" oncontextmenu="return false;"></video>';
			break;
...
<div class="content-view">
	<div class="content-title"><?php echo h($content->title)?></div>
	<div class="content-body content-body-<?php echo $content->kind?>"><?php echo $body;?></div>
