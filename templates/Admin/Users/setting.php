...
<div class="users-setting">
	<div class="panel panel-default">
		...
		<?php
			...
			echo $this->Form->control('new_password',  ['label' => __('新しいパスワード'), 'type' => 'password', 'autocomplete' => 'new-password']);
			echo $this->Form->control('new_password2', ['label' => __('新しいパスワード (確認用)'),'type' => 'password','autocomplete' => 'new-password']);
