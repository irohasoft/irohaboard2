...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $contentsQuestion->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $contentsQuestion->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="contentsQuestions form content">
            ...
            <fieldset>
                <legend><?= __('Edit Contents Question') ?></legend>
                <?php
